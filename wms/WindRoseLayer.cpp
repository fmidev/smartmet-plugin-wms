...
std::size_t WindRoseLayer::hash_value(const State& theState) const
{
  try
  {
    ...
    boost::hash_combine(hash, Dali::hash_value(starttimeoffset));
    boost::hash_combine(hash, Dali::hash_value(endtimeoffset));
    boost::hash_combine(hash, Dali::hash_value(windrose, theState));
    boost::hash_combine(hash, Dali::hash_value(observations, theState));
