...
std::string getMeanTemperatureColumnName(const Fmi::DateTime& t)
{
  try
  {
    ...
    std::string day(
        (t.date().month() == 2 && t.date().day() == 29) ? "28" : Fmi::to_string(t.date().day()));
  ...
  catch (...)
  {
    throw Fmi::Exception::Trace(BCP, "Operation failed!")
        .addParameter("Time", Fmi::to_simple_string(t));
  }
}
                         ...
                         const std::map<std::string, std::string>& parameters)
{
  ...
  {
    throw Fmi::Exception::Trace(BCP, "Operation failed!").addParameter("param_name", param_name);
  }
}
                                        ...
                                        State& theState) const
{
  try
  {
    ...
    background_ellipse_cdt["attributes"]["cx"] =
        Fmi::to_string(xpos + (text_dimension.height * 0.5));
    background_ellipse_cdt["attributes"]["cy"] =
        Fmi::to_string(ypos - (text_dimension.height * 0.5));
                               ...
                               const State& theState) const
{
  try
  {
    ...
    wktString = "MULTILINESTRING((" + Fmi::to_string(xLeft) + " " +
                Fmi::to_string(firstHorizontalY) + ", " + Fmi::to_string(xRight) + " " +
                Fmi::to_string(firstHorizontalY) + "),";
    ...
    for (unsigned int i = 0; i < rows.size(); i++)
    {
      ...
      addTextField(
          xpos, ypos, rows2, theFilter.text_attributes, theGlobals, theLayersCdt, theState);
    }
  }
  catch (...)
  {
                                  ...
                                  const State& theState)
{
  try
  {
    ...
    int arrow_x_coord =
        lround(theArrowAngle >= 90 && theArrowAngle <= 270 ? x_coord
                                                           : x_coord + text_dimension_first.width);
  ...
  {
    throw Fmi::Exception::Trace(BCP, "Operation failed!")
        .addParameter("FirstName", theFirstName)
        .addParameter("SecondName", theSecondName);
  }
}
                                 ...
                                 const State& theState) const
{
  ...
  {
    throw Fmi::Exception::Trace(BCP, "Operation failed!")
        .addParameter("MapID", Fmi::to_string(theMapId));
  }
}
                                   ...
                                   State& theState) const
{
  ...
  try
  {
    ...
    {
      handleNamedLocation(
          theResultItem, theFilter, theGlobals, theLayersCdt, theGroupCdt, theState);
    }
  ...
  {
    throw Fmi::Exception::Trace(BCP, "Operation failed!")
        .addParameter("layer_subtype", layer_subtype);
  }
}
