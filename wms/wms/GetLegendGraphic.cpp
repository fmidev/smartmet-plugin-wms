...
GetLegendGraphic::GetLegendGraphic(const Config& theConfig) : itsConfig(theConfig) {}

void GetLegendGraphic::parseHTTPRequest(const Engine::Querydata::Engine& theQEngine,
...
Json::Value GetLegendGraphic::json() const
{
  try
  {
