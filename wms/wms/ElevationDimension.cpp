...
ElevationDimension::ElevationDimension(std::string level_name,
...
void ElevationDimension::initDefaultElevation()
{
...
bool ElevationDimension::isValidElevation(int elevation) const
{
  return itsElevations.find(elevation) != itsElevations.end();
}

const std::string& ElevationDimension::getUnitSymbol() const
{
  return itsUnitSymbol;
}

const std::string& ElevationDimension::getCapabilities() const
{
  return itsCapabilities;
}

const std::string& ElevationDimension::getLevelName() const
{
  return itsLevelName;
}

bool ElevationDimension::isOK() const
{
...
bool ElevationDimension::isIdentical(const ElevationDimension& td) const
{
