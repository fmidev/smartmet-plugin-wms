...
{
 public:
  Config(const Plugin::Dali::Config& daliConfig,
  ...
  const std::map<std::string, SupportedReference>& supportedWMSReferences() const;
  ...
  SharedLayer getLayer(const std::string& theLayerName) const;
 ...
 private:
  ...
  using LayerMap = std::map<std::string, LayerProxy>;
  ...
  LayerHierarchy::HierarchyType itsLayerHierarchyType = LayerHierarchy::HierarchyType::flat;
