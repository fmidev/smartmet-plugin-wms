// ======================================================================
/*!
 * \brief Settings for legend graphic
 */
// ======================================================================
...
struct LegendGraphicLayout
{
  ...
  std::map<std::string, unsigned int> legend_width_per_language;  // legend width per language
  unsigned int
      output_document_width;  // size of non-automatically generated documents, default 500*500
  unsigned int output_document_height;
};

class LegendGraphicSettings
{
 public:
  explicit LegendGraphicSettings(const libconfig::Config& config);
  explicit LegendGraphicSettings(bool initDefaults = false);
  void merge(const LegendGraphicSettings& settings);
...
std::ostream& operator<<(std::ostream& ost, const LegendGraphicSettings& lgs);
