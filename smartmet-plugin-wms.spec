...
#TestRequires: smartmet-library-timeseries-devel >= 22.10.10
#TestRequires: smartmet-engine-grid-devel >= 22.10.10
...
#TestRequires: redis
%if %{with observation}
#TestRequires: smartmet-engine-observation-devel >= 22.10.10
%endif
