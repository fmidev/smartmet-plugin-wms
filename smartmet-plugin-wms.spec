...
#TestRequires: smartmet-engine-gis-devel >= 24.7.12
#TestRequires: smartmet-engine-querydata-devel >= 24.7.12
...
#TestRequires: redis
%if %{with observation}
#TestRequires: smartmet-engine-observation-devel >= 24.7.12
%endif
