...
- Thread naming: Renamed the capabilities update task
...
- Expose the Trax grid smoother in layer config and forward it to the grid-engine contouring path
* Wed Jun 24 2026 Mika Heiskanen <mika.heiskanen@fmi.fi> - 26.6.24-1.fmi
- Added contour.worker_threads configuration and a contour_threads layer override for band-parallel contouring
...
- Added avi-engine requirements
* Tue Apr 28 2026 Mika Heiskanen <mika.heiskanen@fmi.fi> - 26.4.28-1.fmi
- Link explicitly against smartmet-library-grid-files and -trax (was relying on transitive linking)
