...
%endif
%if %{with observation}
BuildRequires: smartmet-engine-observation-devel >= 23.6.122
%endif
...
#TestRequires: smartmet-engine-querydata-devel >= 23.6.13
...
#TestRequires: redis
%if %{with observation}
#TestRequires: smartmet-engine-observation-devel >= 23.6.122
%endif
