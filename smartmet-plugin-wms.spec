...
#TestRequires: smartmet-engine-geonames-devel >= 23.4.27
#TestRequires: smartmet-engine-gis-devel >= 22.12.21
#TestRequires: smartmet-engine-querydata-devel >= 23.6.6
...
#TestRequires: smartmet-library-spine-devel >= 23.6.6
