...
| `map_simplifier_dp.json` — Douglas-Peucker @ 1 px (~64 % vertex reduction). Visible angular cuts on the curved coastline; instructive but not the recommended choice for coastlines. | `{ ..., "simplifier": "douglas_peucker", "tolerance": 1.0 }`                                                                                                  |
| `map_simplifier_vw.json` — Visvalingam-Whyatt @ 2 px (~67 % reduction). Smoother result than DP; the recommended default for natural coastlines.                                     | `{ ..., "simplifier": "visvalingam_whyatt", "tolerance": 2.0 }`                                                                                               |
