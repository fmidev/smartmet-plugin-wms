...
| `map_simplifier_dp.json` — Douglas-Peucker @ 3 px (~20 % vertex reduction, ≈ 36 000 remaining). Spiky/saw-toothed coastline; instructive but not the recommended choice for natural features. | `{ ..., "simplifier": "douglas_peucker", "tolerance": 3.0 }`                                                                                                  |
| `map_simplifier_vw.json` — Visvalingam-Whyatt @ 5 px (~19 % reduction, ≈ 37 000 remaining). Blockier than the baseline but preserves the overall shape character; the recommended default for natural coastlines. | `{ ..., "simplifier": "visvalingam_whyatt", "tolerance": 5.0 }`                                                                                               |
| `map_amalgamate.json` — amalgamation only, `amalgamation_length=0.05`, `amalgamation_area=0.0005` (≈ 3 km gap, ≈ 1.5 km² minimum island; ~94 % vertex reduction, ≈ 2 500 remaining). Hundreds of small archipelago islands collapse into chunkier outlines while distinct islands and the mainland coast are kept. | `{ ..., "amalgamation_length": 0.05, "amalgamation_area": 0.0005 }`                                                                                            |
| `map_amalgamate_simplified.json` — same amalgamation followed by Visvalingam-Whyatt @ 1.5 px (~97 % total reduction, ≈ 1 300 remaining). The recommended pipeline for archipelago / dense-coastline rendering. | `{ ..., "amalgamation_length": 0.05, "amalgamation_area": 0.0005, "simplifier": "visvalingam_whyatt", "tolerance": 1.5 }`                                     |
